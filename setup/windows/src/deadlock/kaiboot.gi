...
"r_size_cull_threshold" "1.6" //was 1.2, 5 is too aggressive
"r_hair_ao" "0"
...
// ================ BOOT MODIFICATIONS AND ADDITIONS ================
...
// ================ BOOT MODIFICATIONS AND ADDITIONS (MORE RISKY COMMANDS) ================
"anim_disable" "true"
"cl_phys_enabled" "false"


// ================ BOOT CASCADE MODIFICATIONS ================
...
// ================ BOOT CORE RENDERING & LIGHTING MODIFICATIONS ================
"r_ssao_strength" "0"
"r_post_bloom" "0"
